...
export default function HostelDetail() {
  ...
  const getGalleryImages = (): string[] => {
    ...
    switch (hostel.category) {
      case 'Girls':
        return [
          '/assets/generated/girls-hostel-room-1.dim_800x600.png',
          '/assets/generated/girls-hostel-common-1.dim_800x600.png',
          '/assets/generated/girls-hostel-1.dim_800x600.png',
          '/assets/generated/girls-hostel-2.dim_800x600.png',
          '/assets/generated/hostel-girls-dorm.dim_800x600.png',
        ];
      case 'Boys':
        return [
          '/assets/generated/boys-hostel-room-1.dim_800x600.png',
          '/assets/generated/boys-hostel-common-1.dim_800x600.png',
          '/assets/generated/boys-hostel-1.dim_800x600.png',
          '/assets/generated/boys-hostel-2.dim_800x600.png',
          '/assets/generated/hostel-boys-dorm.dim_800x600.png',
        ];
      case 'Co-Living':
        return [
          '/assets/generated/coliving-lounge-1.dim_800x600.png',
          '/assets/generated/coliving-room-1.dim_800x600.png',
          '/assets/generated/co-living-1.dim_800x600.png',
          '/assets/generated/co-living-2.dim_800x600.png',
          '/assets/generated/hostel-coliving.dim_800x600.png',
        ];
      default:
        return [
          '/assets/generated/hostel-common-area.dim_800x600.png',
          '/assets/generated/hostel-kitchen.dim_800x600.png',
        ];
    }
  };

  const sharingOptions = [
    { label: 'Single Room', sharing: Number(hostel.roomCapacityDetails.sharing1), price: Number(hostel.roomCapacityDetails.price1) },
    { label: 'Double Sharing', sharing: Number(hostel.roomCapacityDetails.sharing2), price: Number(hostel.roomCapacityDetails.price2) },
    { label: 'Triple Sharing', sharing: Number(hostel.roomCapacityDetails.sharing3), price: Number(hostel.roomCapacityDetails.price3) },
    { label: 'Four Sharing', sharing: Number(hostel.roomCapacityDetails.sharing4), price: Number(hostel.roomCapacityDetails.price4) },
    { label: 'Five Sharing', sharing: Number(hostel.roomCapacityDetails.sharing5), price: Number(hostel.roomCapacityDetails.price5) },
  ].filter((option) => option.price > 0);

  const getSharingLabel = (sharing: number, label: string) => {
    ...
    if (sharing === 5) return 'Five Sharing';
    return label;
  };
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-sm">
                        {getSharingLabel(option.sharing, option.label)}
                      </span>
                    </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    Choose from single to five-person sharing
                  </div>
                </div>
              </div>
              <Separator />
